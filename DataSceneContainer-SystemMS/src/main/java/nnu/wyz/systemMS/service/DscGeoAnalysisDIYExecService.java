...
@Service
@Slf4j
public class DscGeoAnalysisDIYExecService {
    ...
    private static final String CONTAINER_ID = "8c1e1b8807a3f47aef0e54427df7fce7ac5601eabfa94be17eb40a2ca300168c";
    ...
    void invoke(DscGeoAnalysisExecTask dscGeoAnalysisExecTask) {
        ...
        ExecCreateCmdResponse containerResponse = pythonDockerConfig.getDockerClient().execCreateCmd(CONTAINER_ID)
        ...
        try {
            pythonDockerConfig.getDockerClient().execStartCmd(containerResponse.getId())
